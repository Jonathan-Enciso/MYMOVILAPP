...
EBfindShiftStart eBfindShiftStartFromJson(String str) =>
    EBfindShiftStart.fromJson(json.decode(str));

String eBfindShiftStartToJson(EBfindShiftStart data) =>
...
class EBfindShiftStart {
  ...
  factory EBfindShiftStart.fromJson(Map<String, dynamic> json) =>
      EBfindShiftStart(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        presentationService: json["presentation_service"] == null
            ? null
            : Service.fromJson(json["presentation_service"]),
        drivingService: json["driving_service"] == null
            ? null
            : Service.fromJson(json["driving_service"]),
        isShiftStarted:
            json["is_shift_started"] == null ? null : json["is_shift_started"],
        dateShiftStarted: json["date_shift_started"] == null
            ? null
            : json["date_shift_started"],
        busLocation: json["bus_location"] == null ? null : json["bus_location"],
      );

  Map<String, dynamic> toJson() => {
        "presentation_service":
            presentationService == null ? null : presentationService.toJson(),
        "driving_service":
            drivingService == null ? null : drivingService.toJson(),
        "is_shift_started": isShiftStarted == null ? null : isShiftStarted,
        "date_shift_started":
            dateShiftStarted == null ? null : dateShiftStarted,
